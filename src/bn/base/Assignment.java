...
public class Assignment extends ArrayMap<RandomVariable,Value> implements bn.core.Assignment {
	...
	public static void main(String[] argv) {
		...
		Value a = new BooleanValue(Boolean.TRUE);
		
		Value t1 = new StringValue("true");
		Value f1 = new StringValue("false");
		
		Value t2 = new BooleanValue(Boolean.TRUE);
		Value f2 = new BooleanValue(Boolean.FALSE);
		...
		// Random variable "A" with value "a1"
		assignment.put(A, a1);
		// Random variable "B" with value "b1"
		assignment.put(B, b1);
		System.out.println(assignment);
		
		// Change Random variable "B"'s value to "b2"
		assignment.put(B, b2);
		System.out.println(assignment);
		
		// Change Random variable "A"'s value to "a3"
		assignment.put(A, a3);
		...
		RandomVariable C = new BooleanVariable("C");
		System.out.println("@@@@Testing contains: "+assignment.containsKey(C));
		...
		//assignment random variable set
		Set<RandomVariable> avs = assignment.variableSet();
		System.out.println("final assignment's variable set: "+ avs);
		
		System.out.println(allPossibleAssignments(avs));
